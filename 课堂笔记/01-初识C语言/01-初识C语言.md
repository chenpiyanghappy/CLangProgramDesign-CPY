...
温馨提示：本教程中推荐的IDE工具在校园网环境下（除非你能想到方法连上1000M的有线宽带）下载非常慢，推荐使用JetBrains的开发工具，下载和安装步骤与下文
介绍的「Visual Studio」的安装方式相同，请对照查看。

注意： JetBrains、开发工具的不同点为

1、JetBrains的C++/C语言开发工具的名称为「Clion」，其官网[请点击此处](https://www.jetbrains.com.cn/clion/)，快速下载地址[请点击此处（链接更新时间：2026/03/07）](https://download.jetbrains.com/cpp/CLion-2025.3.3.exe)

2、JetBrains IDE工具也需要登陆账户，JetBrains账号注册[请点击此处](https://account.jetbrains.com/signup)（账号注册链接为英文，可以使用浏
览器自带翻译工具辅助填写）

3、JetBrains IDE工具存在付费订阅功能，学生在校可以免费使用，教育资格申请[请点击此处](https://www.jetbrains.com.cn/academy/student-pack/)，
详细认证方式请遵循网站指引。（JetBrains学生认证每年都需要认证）

（关于如何在Clion中完成开发，请查看[补充内容](01-初识C语言_补充内容.md)中的教程）

### Visual Studio 安装和环境配置
